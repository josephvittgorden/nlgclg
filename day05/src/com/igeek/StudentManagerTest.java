...
public class StudentManagerTest {
	...
	/*
	 * //添加学生 public static void addStudent(ArrayList<Student> array) { //创建键盘录入对象
	 * Scanner sc = new Scanner(System.in);
	 * 
	 ...
	 * s.setAge(age); s.setAddress(address);
	 * 
	 * //把学生对象作为元素添加到集合 array.add(s);
	 * 
